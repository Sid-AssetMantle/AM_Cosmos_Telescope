...
<p align="center" width="100%">
  <a href="https://github.com/Sid-AssetMantle/AM_module/actions/workflows/run-tests.yml">
    <img height="20" src="https://github.com/Sid-AssetMantle/AM_module/actions/workflows/run-tests.yml/badge.svg" />
  </a>
   <a href="https://github.com/Sid-AssetMantle/AM_module/blob/main/LICENSE"><img height="20" src="https://img.shields.io/badge/license-MIT-blue.svg"></a>
</p>
...
```js
import { assetmantle } from 'AM_module';
...
Import the `assetmantle` object from `AM_module`. 
...
```js
import { cosmwasm } from "AM_module";
...
```js
import { getSigningAssetmantleClient } from 'AM_module';
...
Look inside of `scripts/codegen.ts` and configure the settings for bundling your SDK and contracts into `AM_module`:
